...
describe('ngb-calendar-islamic-civil', () => {
  ...
  const calendar = new NgfCalendarIslamicCivil();
  describe('toGregorian', () => {
    it('should convert correctly from Hijri to Gregorian', () => {
      DATE_TABLE.forEach(element => {
        let iDate = new NgfDate(element[0], element[1], element[2]);
  ...
  it('should return day of week', () => {
    expect(calendar.getWeekday(new NgfDate(1437, 12, 15))).toEqual(7);
    expect(calendar.getWeekday(new NgfDate(1437, 12, 16))).toEqual(1);
    expect(calendar.getWeekday(new NgfDate(1437, 12, 17))).toEqual(2);
    expect(calendar.getWeekday(new NgfDate(1437, 12, 18))).toEqual(3);
    expect(calendar.getWeekday(new NgfDate(1437, 12, 19))).toEqual(4);
    expect(calendar.getWeekday(new NgfDate(1437, 12, 20))).toEqual(5);
    expect(calendar.getWeekday(new NgfDate(1437, 12, 21))).toEqual(6);
    expect(calendar.getWeekday(new NgfDate(1431, 1, 11))).toEqual(1);
    expect(calendar.getWeekday(new NgfDate(1431, 7, 22))).toEqual(7);
    expect(calendar.getWeekday(new NgfDate(1431, 2, 3))).toEqual(2);
    expect(calendar.getWeekday(new NgfDate(1431, 3, 10))).toEqual(3);
    expect(calendar.getWeekday(new NgfDate(1431, 4, 23))).toEqual(4);
    expect(calendar.getWeekday(new NgfDate(1202, 2, 19))).toEqual(5);
    expect(calendar.getWeekday(new NgfDate(1431, 7, 21))).toEqual(6);
  });
  it('should add days to date', () => {
    expect(calendar.getNext(new NgfDate(1431, 1, 30))).toEqual(new NgfDate(1431, 2, 1));
  ...
  it('should subtract days from date', () => {
    expect(calendar.getPrev(new NgfDate(1431, 2, 1))).toEqual(new NgfDate(1431, 1, 30));
    expect(calendar.getPrev(new NgfDate(1431, 3, 1))).toEqual(new NgfDate(1431, 2, 29));
  ...
  describe('setDay', () => {
    it('should return correct value of day', () => {
      expect(calendar.getNext(new NgfDate(1202, 9, 1), 'd', 18).day).toEqual(19);
      expect(calendar.getNext(new NgfDate(1431, 1, 1), 'd', 0).day).toEqual(1);
      expect(calendar.getNext(new NgfDate(1431, 1, 1), 'd', 30).day).toEqual(1);
      expect(calendar.getNext(new NgfDate(1437, 1, 1), 'd', 60).day).toEqual(2);
      expect(calendar.getNext(new NgfDate(1431, 2, 1), 'd', -1).day).toEqual(30);
      expect(calendar.getNext(new NgfDate(1431, 2, 1), 'd', -2).day).toEqual(29);
      expect(calendar.getNext(new NgfDate(1431, 2, 1), 'd', -3).day).toEqual(28);
    });
  });

  describe('setMonth', () => {
    it('should return correct value of month', () => {
      expect(calendar.getNext(new NgfDate(1202, 9, 1), 'm', 0).month).toEqual(9);
      expect(calendar.getNext(new NgfDate(1431, 1, 30), 'm', 0).month).toEqual(1);
  ...
  describe('setYear', () => {
    it('should return correct value of yar', () => {
      expect(calendar.getNext(new NgfDate(1200, 1, 1), 'y', 2).year).toEqual(1202);
      expect(calendar.getNext(new NgfDate(1430, 11, 30), 'y', 1).year).toEqual(1431);
      expect(calendar.getNext(new NgfDate(1431, 12, 1), 'd', 30).year).toEqual(1432);
      expect(calendar.getNext(new NgfDate(1431, 1, 1), 'm', 12).year).toEqual(1432);
      ...
      expect(calendar.getNext(new NgfDate(1431, 1, 1), 'm', -1).year).toEqual(1430);
