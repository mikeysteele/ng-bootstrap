...
import {NgfDateAdapter, NgfDatepickerModule} from './datepicker.module';
...
describe('NgfInputDatepicker', () => {

  beforeEach(() => {
    TestBed.configureTestingModule({declarations: [TestComponent], imports: [NgfDatepickerModule, FormsModule]});
  });
  ...
  describe('open, close and toggle', () => {
    ...
    it('should allow controlling datepicker popup from outside', () => {
      ...
      expect(fixture.nativeElement.querySelector('ngf-datepicker')).not.toBeNull();

      buttons[1].click();  // close
      fixture.detectChanges();
      expect(fixture.nativeElement.querySelector('ngf-datepicker')).toBeNull();
    ...
    it('should support the "position" option',
       () => { createTestCmpt(`<input ngfDatepicker #d="ngfDatepicker" [placement]="'bottom-right'">`); });
  });
  ...
  describe('ngModel interactions', () => {
    it('should not change again the value in the model on a change coming from the model (popup closed)',
       fakeAsync(() => {
         const fixture = createTestCmpt(`<input ngfDatepicker [(ngModel)]="date">`);
         fixture.detectChanges();

         const input = fixture.nativeElement.querySelector('input');

         const value = new NgfDate(2018, 8, 29);
    ...
    it('should not change again the value in the model on a change coming from the model (popup opened)',
       fakeAsync(() => {
         const fixture = createTestCmpt(`<input ngfDatepicker [(ngModel)]="date" #d="ngfDatepicker">
      <button (click)="open(d)">Open</button>`);
         fixture.detectChanges();
    ...
    it('should not update the model twice with the same value on input and on change', fakeAsync(() => {
         const fixture =
             createTestCmpt(`<input ngfDatepicker [(ngModel)]="date" (ngModelChange)="onModelChange($event)">`);
    ...
    it('should set only valid dates', fakeAsync(() => {
         ...
         fixture.componentInstance.date = new NgfDate(300000, 1, 1);
         fixture.detectChanges();
         tick();
         expect(input.value).toBe('');

         fixture.componentInstance.date = new NgfDate(2017, 2, null);
         fixture.detectChanges();
         tick();
         expect(input.value).toBe('');

         fixture.componentInstance.date = new NgfDate(2017, null, 5);
         fixture.detectChanges();
         tick();
         expect(input.value).toBe('');

         fixture.componentInstance.date = new NgfDate(null, 2, 5);
         fixture.detectChanges();
         tick();
         expect(input.value).toBe('');

         fixture.componentInstance.date = new NgfDate(<any>'2017', <any>'03', <any>'10');
         fixture.detectChanges();
         tick();
         expect(input.value).toBe('');
       }));
    ...
    it('should propagate disabled state', fakeAsync(() => {
         const fixture = createTestCmpt(`
        <input ngfDatepicker [(ngModel)]="date" #d="ngfDatepicker" [disabled]="isDisabled">
        <button (click)="open(d)">Open</button>`);
         ...
         tick();
         fixture.detectChanges();
         const buttonInDatePicker = fixture.nativeElement.querySelector('ngf-datepicker button');

         expect(fixture.nativeElement.querySelector('ngf-datepicker')).not.toBeNull();
         expect(input.disabled).toBeTruthy();
         expect(buttonInDatePicker.disabled).toBeTruthy();

         const dayElements = fixture.nativeElement.querySelectorAll('ngf-datepicker-month-view .ngb-dp-day');
         ...
         const dayElements2 = fixture.nativeElement.querySelectorAll('ngf-datepicker-month-view .ngb-dp-day');
    ...
    it('should propagate disabled state without form control', () => {
      const fixture = createTestCmpt(`
        <input ngfDatepicker #d="ngfDatepicker" [disabled]="isDisabled">
        <button (click)="open(d)">Open</button>`);
      fixture.componentInstance.isDisabled = true;
      fixture.detectChanges();
    ...
    it('should propagate touched state when setting a date', fakeAsync(() => {
         const fixture = createTestCmpt(`
      <input ngfDatepicker [(ngModel)]="date" #d="ngfDatepicker">
      <button (click)="open(d)">Open</button>`);
    ...
    it('should update model with updateOnBlur when selecting a date', fakeAsync(() => {
         const fixture = createTestCmpt(`
      <input ngfDatepicker [startDate]="{year: 2018, month: 3}" [(ngModel)]="date" #d="ngfDatepicker"
             [ngModelOptions]="{updateOn: 'blur'}">`);

         const inputDebugEl = fixture.debugElement.query(By.css('input'));
         const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
  ...
  describe('manual data entry', () => {
    ...
    it('should reformat value entered by a user when it is valid', fakeAsync(() => {
         const fixture = createTestCmpt(`<input ngfDatepicker (ngModelChange)="date">`);
         const inputDebugEl = fixture.debugElement.query(By.css('input'));
  ...
  describe('validation', () => {
    ...
    describe('values set from model', () => {
      ...
      it('should not return errors for valid model', fakeAsync(() => {
           const fixture = createTestCmpt(
               `<form><input ngfDatepicker [ngModel]="{year: 2017, month: 04, day: 04}" name="dp"></form>`);
           const form = fixture.debugElement.query(By.directive(NgForm)).injector.get(NgForm);

           fixture.detectChanges();
           tick();
           expect(form.control.valid).toBeTruthy();
           expect(form.control.hasError('ngfDate', ['dp'])).toBeFalsy();
         }));

      it('should not return errors for empty model', fakeAsync(() => {
           const fixture = createTestCmpt(`<form><input ngfDatepicker [ngModel]="date" name="dp"></form>`);
           const form = fixture.debugElement.query(By.directive(NgForm)).injector.get(NgForm);
      ...
      it('should return "invalid" errors for invalid model', fakeAsync(() => {
           const fixture = createTestCmpt(`<form><input ngfDatepicker [ngModel]="5" name="dp"></form>`);
           const form = fixture.debugElement.query(By.directive(NgForm)).injector.get(NgForm);

           fixture.detectChanges();
           tick();
           expect(form.control.invalid).toBeTruthy();
           expect(form.control.getError('ngfDate', ['dp']).invalid).toBe(5);
         }));

      it('should return "requiredBefore" errors for dates before minimal date', fakeAsync(() => {
           const fixture = createTestCmpt(`<form>
          <input ngfDatepicker [ngModel]="{year: 2017, month: 04, day: 04}" [minDate]="{year: 2017, month: 6, day: 4}" name="dp">
        </form>`);
           const form = fixture.debugElement.query(By.directive(NgForm)).injector.get(NgForm);
           ...
           tick();
           expect(form.control.invalid).toBeTruthy();
           expect(form.control.getError('ngfDate', ['dp']).requiredBefore).toEqual({year: 2017, month: 6, day: 4});
         }));

      it('should return "requiredAfter" errors for dates after maximal date', fakeAsync(() => {
           const fixture = createTestCmpt(`<form>
          <input ngfDatepicker [ngModel]="{year: 2017, month: 04, day: 04}" [maxDate]="{year: 2017, month: 2, day: 4}" name="dp">
        </form>`);
           const form = fixture.debugElement.query(By.directive(NgForm)).injector.get(NgForm);
           ...
           tick();
           expect(form.control.invalid).toBeTruthy();
           expect(form.control.getError('ngfDate', ['dp']).requiredAfter).toEqual({year: 2017, month: 2, day: 4});
         }));
      ...
      it('should update validity status when minDate changes', fakeAsync(() => {
           const fixture = createTestCmpt(`<form>
          <input ngfDatepicker [ngModel]="{year: 2017, month: 2, day: 4}" [minDate]="date" name="dp">
        </form>`);
           const form = fixture.debugElement.query(By.directive(NgForm)).injector.get(NgForm);
      ...
      it('should update validity status when maxDate changes', fakeAsync(() => {
           const fixture = createTestCmpt(`<form>
          <input ngfDatepicker [ngModel]="{year: 2017, month: 2, day: 4}" [maxDate]="date" name="dp">
        </form>`);
           const form = fixture.debugElement.query(By.directive(NgForm)).injector.get(NgForm);
  ...
  describe('options', () => {
    ...
    it('should propagate the "dayTemplate" option', () => {
      const fixture = createTestCmpt(`<ng-template #t></ng-template><input ngfDatepicker [dayTemplate]="t">`);
      const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);

      dpInput.open();
      fixture.detectChanges();

      const dp = fixture.debugElement.query(By.css('ngf-datepicker')).injector.get(NgfDatepicker);
      expect(dp.dayTemplate).toBeDefined();
    });

    it('should propagate the "dayTemplateData" option', () => {
      const fixture = createTestCmpt(`<input ngfDatepicker [dayTemplateData]="noop">`);
      const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
    ...
    it('should propagate the "displayMonths" option', () => {
      const fixture = createTestCmpt(`<input ngfDatepicker [displayMonths]="3">`);
      const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
    ...
    it('should propagate the "firstDayOfWeek" option', () => {
      const fixture = createTestCmpt(`<input ngfDatepicker [firstDayOfWeek]="5">`);
      const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
    ...
    it('should propagate the "footerTemplate" option', () => {
      const fixture = createTestCmpt(`<ng-template #t></ng-template><input ngfDatepicker [footerTemplate]="t">`);
      const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
    ...
    it('should propagate the "markDisabled" option', () => {
      const fixture = createTestCmpt(`<input ngfDatepicker [markDisabled]="noop">`);
      const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
    ...
    it('should propagate the "minDate" option', () => {
      const fixture = createTestCmpt(`<input ngfDatepicker [minDate]="{year: 2016, month: 9, day: 13}">`);
      const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
    ...
    it('should propagate the "maxDate" option', () => {
      const fixture = createTestCmpt(`<input ngfDatepicker [maxDate]="{year: 2016, month: 9, day: 13}">`);
      const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
    ...
    it('should propagate the "outsideDays" option', () => {
      const fixture = createTestCmpt(`<input ngfDatepicker outsideDays="collapsed">`);
      const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
    ...
    it('should propagate the "navigation" option', () => {
      const fixture = createTestCmpt(`<input ngfDatepicker navigation="none">`);
      const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
    ...
    it('should propagate the "showWeekdays" option', () => {
      const fixture = createTestCmpt(`<input ngfDatepicker [showWeekdays]="true">`);
      const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
    ...
    it('should propagate the "showWeekNumbers" option', () => {
      const fixture = createTestCmpt(`<input ngfDatepicker [showWeekNumbers]="true">`);
      const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
    ...
    it('should propagate the "startDate" option', () => {
      const fixture = createTestCmpt(`<input ngfDatepicker [startDate]="{year: 2016, month: 9}">`);
      const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
    ...
    it('should propagate model as "startDate" option when "startDate" not provided', fakeAsync(() => {
         const fixture = createTestCmpt(`<input ngfDatepicker [ngModel]="{year: 2016, month: 9, day: 13}">`);
         const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
         ...
         const dp = fixture.debugElement.query(By.css('ngf-datepicker')).injector.get(NgfDatepicker);
         expect(dp.startDate).toEqual(new NgfDate(2016, 9, 13));
       }));

    it('should relay the "navigate" event', () => {
      const fixture =
          createTestCmpt(`<input ngfDatepicker [startDate]="{year: 2016, month: 9}" (navigate)="onNavigate($event)">`);
      const dpInput = fixture.debugElement.query(By.directive(NgfInputDatepicker)).injector.get(NgfInputDatepicker);
    ...
    it('should emit both "dateSelect" and "onModelChange" events', () => {
      const fixture = createTestCmpt(`
          <input ngfDatepicker ngModel [startDate]="{year: 2018, month: 3}"
      ...
      expect(fixture.componentInstance.onDateSelect).toHaveBeenCalledWith(new NgfDate(2018, 3, 1));
  ...
  describe('container', () => {
    ...
    it('should be appended to the element matching the selector passed to "container"', () => {
      const selector = 'body';
      const fixture = createTestCmpt(`
          <input ngfDatepicker #d="ngfDatepicker" container="${selector}">
          <button (click)="open(d)">Open</button>
      `);
      ...
      expect(fixture.nativeElement.querySelector('ngf-datepicker')).toBeNull();
      expect(document.querySelector(selector).querySelector('ngf-datepicker')).not.toBeNull();
    });
    ...
    it('should properly destroy datepicker window when the "container" option is used', () => {
      ...
      expect(fixture.nativeElement.querySelector('ngf-datepicker')).toBeNull();
      expect(document.querySelector(selector).querySelector('ngf-datepicker')).toBeNull();
    });
  });
  ...
  describe('Native adapter', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        imports: [NgfDatepickerModule, FormsModule],
        providers: [{provide: NgfDateAdapter, useClass: NgfDateNativeAdapter}]
      });
    });

    it('should format bound date as ISO (by default) in the input field', fakeAsync(() => {
         const fixture = createTestNativeCmpt(`<input ngfDatepicker [ngModel]="date">`);
         const input = fixture.nativeElement.querySelector('input');
...
@Injectable()
class NgfDateNativeAdapter extends NgfDateAdapter<Date> {
  ...
  toModel(date: NgfDateStruct): Date { return date ? new Date(date.year, date.month - 1, date.day) : null; }
}
...
class TestComponent {
  ...
  open(d: NgfInputDatepicker) { d.open(); }

  close(d: NgfInputDatepicker) { d.close(); }

  toggle(d: NgfInputDatepicker) { d.toggle(); }
