...
import {NgfActiveModal, NgfModal, NgfModalModule, NgfModalRef} from './modal.module';
...
describe('ngf-modal', () => {
      ...
      toHaveModal: function(util, customEqualityTests) {
        return {
          compare: function(actual, content?, selector?) {
            const allModalsContent = document.querySelector(selector || 'body').querySelectorAll('.reveal-modal');
            let pass = true;
            let errMsg;
          ...
          negativeCompare: function(actual) {
            const allOpenModals = actual.querySelectorAll('ngf-modal-window');
      ...
      toHaveBackdrop: function(util, customEqualityTests) {
        return {
          compare: function(actual) {
            return {
              pass: document.querySelectorAll('ngf-modal-backdrop').length === 1,
              message: `Expected ${actual.outerHTML} to have exactly one backdrop element`
            };
          },
          negativeCompare: function(actual) {
            const allOpenModals = document.querySelectorAll('ngf-modal-backdrop');
  ...
  afterEach(() => {
    ...
    const remainingModalWindows = document.querySelectorAll('ngf-modal-window');
    if (remainingModalWindows.length) {
      fail(`${remainingModalWindows.length} modal windows were left in the DOM.`);
    }

    const remainingModalBackdrops = document.querySelectorAll('ngf-modal-backdrop');
  ...
  describe('default configuration', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({imports: [NgfModalTestModule]});
    ...
    describe('stacked  modals', () => {
      ...
      it('should dismiss modals on ESC in correct order', () => {
        ...
        const ngbModalWindow1 = document.querySelectorAll('ngf-modal-window')[0];
        const ngbModalWindow2 = document.querySelectorAll('ngf-modal-window')[1];
        fixture.detectChanges();
    ...
    describe('backdrop options', () => {
      ...
      it('should dismiss on backdrop click', () => {
        ...
        (<HTMLElement>document.querySelector('ngf-modal-window')).click();
        fixture.detectChanges();
    ...
    describe('keyboard options', () => {
      ...
      it('should dismiss modals on ESC by default', () => {
        ...
        (<DebugElement>getDebugNode(document.querySelector('ngf-modal-window'))).triggerEventHandler('keyup.esc', {});
        fixture.detectChanges();
        expect(fixture.nativeElement).not.toHaveModal();
      });
    ...
    describe('window custom class options', () => {
      ...
      it('should render modals with the correct window custom classes', () => {
        ...
        fixture.detectChanges();
        expect(fixture.nativeElement).toHaveModal('foo');
        expect(document.querySelector('ngf-modal-window')).toHaveCssClass('bar');
    ...
    describe('backdrop custom class options', () => {
      ...
      it('should render modals with the correct backdrop custom classes', () => {
        ...
        fixture.detectChanges();
        expect(fixture.nativeElement).toHaveModal('foo');
        expect(document.querySelector('ngf-modal-backdrop')).toHaveCssClass('my-fancy-backdrop');
    ...
    describe('focus management', () => {
      ...
      it('should return focus to body if no element focused prior to modal opening', () => {
        ...
        fixture.detectChanges();
        expect(fixture.nativeElement).toHaveModal('foo');
        expect(document.activeElement).toBe(document.querySelector('ngf-modal-window'));
      ...
      describe('initial focus', () => {
        it('should focus the proper specified element when [ngbAutofocus] is used', () => {
          ...
          expect(document.activeElement).toBe(document.querySelector('button.withNgfAutofocus'));
          modal.close();
        });
    ...
    describe('window element ordering', () => {
      it('should place newer windows on top of older ones', () => {
        ...
        let windows = document.querySelectorAll('ngf-modal-window');
    ...
    describe('accessibility', () => {
      ...
      it('should support aria-labelledby', () => {
        ...
        const modalElement = <HTMLElement>document.querySelector('ngf-modal-window');
      ...
      it('should add aria-hidden attributes to siblings when attached to body', async(async() => {
           ...
           const modal = document.querySelector('ngf-modal-window');
           const backdrop = document.querySelector('ngf-modal-backdrop');
      ...
      it('should add aria-hidden attributes with modal stacks', async(async() => {
           ...
           let modals = document.querySelectorAll('ngf-modal-window');
           let backdrops = document.querySelectorAll('ngf-modal-backdrop');
           let ariaHidden = document.querySelectorAll('[aria-hidden]');
           ...
           ariaHidden = document.querySelectorAll('[aria-hidden]');
           expect(document.querySelectorAll('ngf-modal-window').length).toBe(1);
           expect(document.querySelectorAll('ngf-modal-backdrop').length).toBe(1);
  ...
  describe('custom global configuration', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule(
          {imports: [NgfModalTestModule], providers: [{provide: NgfModalConfig, useValue: {size: 'sm'}}]});
      fixture = TestBed.createComponent(TestComponent);
    });

    it('should accept global configuration under the NgfModalConfig token', () => {
      const modalInstance = fixture.componentInstance.open('foo');
      fixture.detectChanges();
...
@Component(
    {selector: 'modal-autofocus-cmpt', template: `<button class="withNgfAutofocus" ngbAutofocus>Click Me</button>`})
...
class TestComponent {
  ...
  constructor(public modalService: NgfModal) {}
...
@NgModule({
  ...
  imports: [CommonModule, NgfModalModule],
  entryComponents: [
