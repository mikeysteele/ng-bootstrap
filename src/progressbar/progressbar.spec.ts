...
import {NgfProgressbarModule} from './progressbar.module';
...
describe('ngf-progressbar', () => {
  describe('business logic', () => {
    let progressCmp: NgfProgressbar;

    beforeEach(() => { progressCmp = new NgfProgressbar(new NgfProgressbarConfig()); });

    it('should initialize inputs with default values', () => {
      const defaultConfig = new NgfProgressbarConfig();
  ...
  describe('UI logic', () => {
    ...
    beforeEach(
        () => { TestBed.configureTestingModule({declarations: [TestComponent], imports: [NgfProgressbarModule]}); });

    it('accepts a value and respond to value changes', () => {
      const html = '<ngf-progressbar [value]="value"></ngf-progressbar>';
    ...
    it('accepts a max value and respond to max changes', () => {
      const html = '<ngf-progressbar [value]="value" [max]="max"></ngf-progressbar>';
      const fixture = createTestComponent(html);
    ...
    it('accepts a value and max value above default values', () => {
      const html = '<ngf-progressbar [value]="150" [max]="150"></ngf-progressbar>';
      const fixture = createTestComponent(html);
    ...
    it('accepts a custom type', () => {
      const html = '<ngf-progressbar [value]="value" [type]="type"></ngf-progressbar>';
      const fixture = createTestComponent(html);
    ...
    it('accepts animated as normal attr', () => {
      const html = '<ngf-progressbar [value]="value" [animated]="animated"></ngf-progressbar>';
      const fixture = createTestComponent(html);
    ...
    it('accepts striped as normal attr', () => {
      const html = '<ngf-progressbar [value]="value" [striped]="striped"></ngf-progressbar>';
      const fixture = createTestComponent(html);
    ...
    it('should stay striped when the type changes', () => {
      const html = '<ngf-progressbar [value]="value" [type]="type" [striped]="true"></ngf-progressbar>';
      const fixture = createTestComponent(html);
    ...
    it('sets the min and max values as aria attributes', () => {
      const html = '<ngf-progressbar [value]="130" [max]="150"></ngf-progressbar>';
      const fixture = createTestComponent(html);
    ...
    it('should display the progress-bar label', () => {
      const html = '<ngf-progressbar [value]="150" [max]="150">label goes here</ngf-progressbar>';
      const fixture = createTestComponent(html);
    ...
    it('should display the current percentage value', () => {
      const html = '<ngf-progressbar [showValue]="true" [value]="150" [max]="150"></ngf-progressbar>';
      const fixture = createTestComponent(html);
    ...
    it('should accepts height values', () => {
      const html = '<ngf-progressbar [value]="150" height="10px"></ngf-progressbar>';
      const fixture = createTestComponent(html);
  ...
  describe('Custom config', () => {
    let config: NgfProgressbarConfig;

    beforeEach(() => { TestBed.configureTestingModule({imports: [NgfProgressbarModule]}); });

    beforeEach(inject([NgfProgressbarConfig], (c: NgfProgressbarConfig) => {
      config = c;
      config.max = 1000;
      config.striped = true;
    ...
    it('should initialize inputs with provided config', () => {
      const fixture = TestBed.createComponent(NgfProgressbar);
      fixture.detectChanges();
  ...
  describe('Custom config as provider', () => {
    let config = new NgfProgressbarConfig();
    config.max = 1000;
    config.striped = true;
    config.animated = true;
    config.type = 'success';
    ...
    beforeEach(() => {
      TestBed.configureTestingModule(
          {imports: [NgfProgressbarModule], providers: [{provide: NgfProgressbarConfig, useValue: config}]});
    });
